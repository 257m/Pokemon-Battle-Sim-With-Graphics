...
struct MyPokemon Pokemon1 = {.Poke = VENUSAUR,
							 .Level = 100,
							 .CurrentHp = 20,
							 .Item = Focus_Sash,
							 .Ability = Levitate,
...
struct MyPokemon EnemyPokemon1 = {.Poke = CHARIZARD,
								  .Level = 100,
								  .CurrentHp = 20,
								  .Item = Focus_Sash,
								  .Ability = Levitate,
