...
#define FLOAT_TO_DOUBLE_BYTE(temp_float) {                                      \
	(int8_t)(((int16_t)(temp_float * 10000)) >> 8),                            \
		(int8_t)(((int16_t)(temp_float * 10000)) << 8) \
	}
...
const struct Move MoveList[MOVE_MAX] = {
	...
	{"Scratch",
	 ...
	 MF_Nothing << 5,
	 {0, 0, 0, 0, 0},
	 FLAG_MAKES_CONTACT | FLAG_PROTECT_AFFECTED | FLAG_TYPE_IMMUNITY_AFFECTED},
	// [3] Water Gun
	{"Water Gun",
	 40,
	 100,
	...
	{"Spirit Dance",
	 ...
	 0,
	 MF_STATMOD << 5,
	 {STAT1_1_STAT2_0, 0, STAT1_1_STAT2_0, 0, 100},
	 0},
	// [14] Will-O-Wisp
	{"Will-O-Wisp",
	 0,
	...
	{"Confuse Ray",
	 ...
	 0,
	 MF_OTHERSTATUS << 5,
	 {EFFECT_STATUS_MAX + EFFECT_CONFUSION, 100},
	 FLAG_PROTECT_AFFECTED},
	// [42] Feather Dance
	{"Feather Dance",
	 0,
	...
	{"Luminous Glow",
	 ...
	 0,
	 MF_STATMOD << 5,
	 {0, STAT1_1_STAT2_0, STAT1_1_STAT2_0, 0, 100},
	 0},
	// [45] Earthquake
	{"Earthquake",
	 100,
	...
	{"Web Blast",
	 ...
	 {0, 0, STAT1_n1_STAT2_0, 0, 178, EFFECT_STATUS_MAX + EFFECT_CONFUSION, 50,
	  0, 0, 0},
	 FLAG_PROTECT_AFFECTED | FLAG_TYPE_IMMUNITY_AFFECTED},
	// [50] Illusion Field
	{"Illusion Field",
	 ...
	 {STAT1_n1_STAT2_n1, STAT1_n1_STAT2_n1, STAT1_n1_STAT2_n1,
	  STAT1_n1_STAT2_n1, OTHER | 100, EFFECT_STATUS_MAX + EFFECT_CONFUSION, 100,
	  0, 0, 0},
	 0},
	// [51] Double Edge
	{"Double Edge",
	...
	{"Soothing Light",
	 ...
	 0,
	 MF_HEAL << 5,
	 {HEAL_SELF_LOST, FLOAT_TO_DOUBLE_BYTE(0.75f)},
	 0},
};
