...
void drawSelectionBox(SDL_Rect *rect)
{
	...
	SDL_RenderDrawLine(
		renderer, rect->x + 5, rect->y, rect->x + rect->w - 5, rect->y);
	SDL_SetRenderDrawColor(renderer, 67, 87, 97, 255);
	SDL_RenderDrawLine(
		renderer, rect->x, rect->y + 2, rect->x, rect->y + rect->h - 2);
	...
	SDL_RenderDrawLine(
		renderer, rect->x + 5, rect->y + 3, rect->x + rect->w - 6, rect->y + 3);
	SDL_RenderDrawLine(renderer, rect->x + 5, rect->y + rect->h - 4,
		rect->x + rect->w - 6, rect->y + rect->h - 4);
	SDL_RenderDrawLine(
		renderer, rect->x + 3, rect->y + 5, rect->x + 3, rect->y + rect->h - 6);
