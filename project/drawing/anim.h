void UpdateBattle() {
  clear_free_queue(&garbage_strings);
        ...
        SDL_RenderFillRect(renderer,&DestRect);
				...
				sprintf((free_pointers[0] = malloc(4)),"%d",Parties[0].Member[0]->CurrentHp);
				drawText(free_pointers[0],218-(strlen(free_pointers[0])*5),125,255,255,255,SMALL_FONT);
        ...
        SDL_RenderFillRect(renderer,&DestRect);
				...
				sprintf((free_pointers[0] = malloc(4)),"%d",Parties[1].Member[0]->CurrentHp);
				drawText(free_pointers[0],66-(strlen(free_pointers[0])*5),49,255,255,255,SMALL_FONT);
				free(free_pointers[0]);
...
void DisplayDie(bool eop) {
  Entity TempEntity = {0,0,0,4};
      ...
      clear_free_queue(&garbage_strings);
        ...
        DestRect.x = 149;
        DestRect.y = 16+Pokemon_Front_Sprite_Offsets_y[Parties[1].Member[0]->Poke]+TempEntity.y;
        DestRect.w = 80;
        ...
        SDL_RenderCopy(renderer,Pokemon_Front_Sprites[Parties[1].Member[0]->Poke],&SourceRect,&DestRect);
					} else {
				TempEntity.y += TempEntity.vy;
        ...
        DestRect.h = 80-TempEntity.y;
				...
				SourceRect.w = 80;
				SourceRect.h = 80-TempEntity.y;
        SDL_RenderCopy(renderer,Pokemon_Back_Sprites[Parties[0].Member[0]->Poke],&SourceRect,&DestRect);
