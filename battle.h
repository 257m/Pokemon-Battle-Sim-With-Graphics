  ...
  while (StatCalc) {
    ...
    for (int i = 0;i < 6;i++) {
        ...
        for (int h = 0;h < 4;h++) {
          ...
          if (strcmp(TextBuffer,str_decompress_and_format_free(MoveList[g].Name)) == 0) {
    ...
    fgets(TextBuffer,31,stdin);
    TextBuffer[strcspn(TextBuffer, "\n")] = 0;
    if (strcmp(TextBuffer,"y") == 0) HideMove = 1;
    printf("\033[1A");
    printf("\033[2K");
    printf("Turn on Player Ai? (y/n): ");
    fgets(TextBuffer,31,stdin);
    TextBuffer[strcspn(TextBuffer, "\n")] = 0;
    if (strcmp(TextBuffer,"y") == 0) Parties[0].AI_MODE = 1;
    printf("\033[1A");
    printf("\033[2K");
    printf("Turn on Enemy Ai? (y/n): ");
    fgets(TextBuffer,31,stdin);
    TextBuffer[strcspn(TextBuffer, "\n")] = 0;
    if (strcmp(TextBuffer,"y") == 0) Parties[1].AI_MODE = 1;
    printf("\033[1A");
    printf("\033[2K");
    StatCalc = 0;
    BattleMode = 1;
